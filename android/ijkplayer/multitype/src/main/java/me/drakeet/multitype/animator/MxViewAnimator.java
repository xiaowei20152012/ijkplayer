 ...
 *  *****************************************************************************
 */
package me.drakeet.multitype.animator;
...
public class MxViewAnimator {
     ...
     */
    private static final int DEFAULT_ANIMATION_DELAY_MILLIS = 200;

    /**
     * The default duration in millis of the animations.
     */
    private static final int DEFAULT_ANIMATION_DURATION_MILLIS = 200;
    ...
    private long mAnimationEndMillis;
     ...
     */
    public MxViewAnimator(@NonNull final RecyclerView recyclerView) {
        mRecyclerView = recyclerView;
        mAnimationStartMillis = -1;
        mAnimationEndMillis = -1;
    ...
    private int calculateAnimationDelay(final int position) {
        ...
        mAnimationEndMillis = Math.max(mAnimationEndMillis, SystemClock.uptimeMillis() + delay);
        return delay;
    }
